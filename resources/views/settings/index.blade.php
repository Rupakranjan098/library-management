...
@section('content')
    <form action="{{ route('settings.store') }}" method="POST">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl font-medium shadow-[0_4px_15px_rgba(79,70,229,0.3)] transition-colors flex items-center">
        ...
        @if(session('success'))
        <div class="mb-6 bg-emerald-500/10 border border-emerald-500/25 text-emerald-200 px-6 py-4 rounded-3xl flex items-center space-x-3 shadow-md">
            ...
            <div>
                <span class="font-bold text-sm block leading-none mb-1">Success</span>
                <span class="text-xs text-slate-400">{{ session('success') }}</span>
            </div>
        </div>
        @endif
                        ...
                        <div class="flex-1 space-y-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" name="library_name" class="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-2.5 px-4 text-sm text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" value="{{ \App\Models\Setting::get('library_name', 'Laravel Library') }}">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-slate-300 mb-2">Default Language</label>
                                    <select name="default_language" class="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-2.5 px-4 text-sm text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 appearance-none">
                                        <option value="English" {{ \App\Models\Setting::get('default_language', 'English') == 'English' ? 'selected' : '' }}>English</option>
                                        <option value="Spanish" {{ \App\Models\Setting::get('default_language') == 'Spanish' ? 'selected' : '' }}>Spanish</option>
                                        <option value="French" {{ \App\Models\Setting::get('default_language') == 'French' ? 'selected' : '' }}>French</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <select name="date_format" class="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-2.5 px-4 text-sm text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 appearance-none">
                                        <option value="May 24, 2024 (MMM DD, YYYY)" {{ \App\Models\Setting::get('date_format') == 'May 24, 2024 (MMM DD, YYYY)' ? 'selected' : '' }}>May 24, 2024 (MMM DD, YYYY)</option>
                                        <option value="24/05/2024 (DD/MM/YYYY)" {{ \App\Models\Setting::get('date_format') == '24/05/2024 (DD/MM/YYYY)' ? 'selected' : '' }}>24/05/2024 (DD/MM/YYYY)</option>
                                        <option value="2024-05-24 (YYYY-MM-DD)" {{ \App\Models\Setting::get('date_format') == '2024-05-24 (YYYY-MM-DD)' ? 'selected' : '' }}>2024-05-24 (YYYY-MM-DD)</option>
                                    </select>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-slate-300 mb-2">Time Zone</label>
                                    <select name="timezone" class="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-2.5 px-4 text-sm text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 appearance-none">
                                        <option value="(UTC+05:30) Kolkata, India" {{ \App\Models\Setting::get('timezone') == '(UTC+05:30) Kolkata, India' ? 'selected' : '' }}>(UTC+05:30) Kolkata, India</option>
                                        <option value="(UTC+00:00) London, UK" {{ \App\Models\Setting::get('timezone') == '(UTC+00:00) London, UK' ? 'selected' : '' }}>(UTC+00:00) London, UK</option>
                                        <option value="(UTC-05:00) Eastern Time" {{ \App\Models\Setting::get('timezone') == '(UTC-05:00) Eastern Time' ? 'selected' : '' }}>(UTC-05:00) Eastern Time</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="currency" class="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-2.5 px-4 text-sm text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 appearance-none">
                                    <option value="INR (₹)" {{ \App\Models\Setting::get('currency', 'INR (₹)') == 'INR (₹)' ? 'selected' : '' }}>INR (₹)</option>
                                    <option value="USD ($)" {{ \App\Models\Setting::get('currency') == 'USD ($)' ? 'selected' : '' }}>USD ($)</option>
                                    <option value="EUR (€)" {{ \App\Models\Setting::get('currency') == 'EUR (€)' ? 'selected' : '' }}>EUR (€)</option>
                                </select>
                            </div>
                            ...
                            <div class="pt-4 border-t border-slate-700/50 flex items-center justify-between">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="maintenance_mode" value="1" {{ \App\Models\Setting::get('maintenance_mode', 0) == 1 ? 'checked' : '' }} class="sr-only peer">
                    ...
                    <div class="dark-card rounded-3xl p-8">
                        ...
                        <div class="space-y-5">
                            <div class="flex items-center justify-between">
                                ...
                                <input type="number" name="max_books_per_member" value="{{ \App\Models\Setting::get('max_books_per_member', 5) }}" class="w-20 bg-slate-800/50 border border-slate-700 rounded-lg py-2 px-3 text-sm text-center text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                            </div>
                            <div class="flex items-center justify-between">
                                <div>
                                ...
                                <input type="number" name="borrow_duration" value="{{ \App\Models\Setting::get('borrow_duration', 5) }}" class="w-20 bg-slate-800/50 border border-slate-700 rounded-lg py-2 px-3 text-sm text-center text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                            </div>
                            <div class="flex items-center justify-between">
                                <div>
                                ...
                                <input type="number" name="renewal_period" value="{{ \App\Models\Setting::get('renewal_period', 7) }}" class="w-20 bg-slate-800/50 border border-slate-700 rounded-lg py-2 px-3 text-sm text-center text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                            </div>
                            <div class="pt-2 flex items-center justify-between">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="allow_renewals" value="1" {{ \App\Models\Setting::get('allow_renewals', 1) == 1 ? 'checked' : '' }} class="sr-only peer">
                                    <div class="w-11 h-6 bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"></div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="dark-card rounded-3xl p-8">
                        ...
                        <div class="space-y-5">
                            <div class="flex items-center justify-between">
                                ...
                                <input type="number" name="fine_rate" step="0.01" value="{{ \App\Models\Setting::get('fine_rate', '5.00') }}" class="w-24 bg-slate-800/50 border border-slate-700 rounded-lg py-2 px-3 text-sm text-center text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                            </div>
                            <div class="flex items-center justify-between">
                                <div>
                                ...
                                <input type="number" name="max_fine" step="0.01" value="{{ \App\Models\Setting::get('max_fine', '100.00') }}" class="w-24 bg-slate-800/50 border border-slate-700 rounded-lg py-2 px-3 text-sm text-center text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                            </div>
                            <div class="flex items-center justify-between">
                                <div>
                                ...
                                <input type="number" name="grace_period" value="{{ \App\Models\Setting::get('grace_period', 0) }}" class="w-24 bg-slate-800/50 border border-slate-700 rounded-lg py-2 px-3 text-sm text-center text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <label class="flex items-start space-x-3 cursor-pointer group">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="notify_member_registration" value="1" {{ \App\Models\Setting::get('notify_member_registration', 1) == 1 ? 'checked' : '' }} class="w-4 h-4 rounded border-slate-700 text-indigo-600 focus:ring-indigo-600 bg-slate-800/50">
                            </div>
                        ...
                        <label class="flex items-start space-x-3 cursor-pointer group">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="notify_due_reminder" value="1" {{ \App\Models\Setting::get('notify_due_reminder', 1) == 1 ? 'checked' : '' }} class="w-4 h-4 rounded border-slate-700 text-indigo-600 focus:ring-indigo-600 bg-slate-800/50">
                            </div>
                            <div class="flex flex-col">
                        ...
                        <label class="flex items-start space-x-3 cursor-pointer group">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="notify_overdue_notices" value="1" {{ \App\Models\Setting::get('notify_overdue_notices', 1) == 1 ? 'checked' : '' }} class="w-4 h-4 rounded border-slate-700 text-indigo-600 focus:ring-indigo-600 bg-slate-800/50">
                            </div>
                            <div class="flex flex-col">
