...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-white tracking-tight">Add New Author</h1>
            <p class="text-slate-400 mt-1 text-sm">Add a new author to the database.</p>
        </div>
        ...
        <form action="{{ route('authors.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                ...
                <div>
                    ...
                    <textarea name="bio" rows="5" class="w-full bg-slate-800/50 border border-slate-700 rounded-xl py-3 px-4 text-sm text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"></textarea>
                </div>
            </div>
